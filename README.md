...
그러나 위 episode를 통해 특정 State에서 선택한 Action과 그에 따른 Reward 정보가 생기게 되었다. 이 정보를 저장하고 다음 episode를 시작하면 특정 State에서 Action을 선택할 때 저장된 Reward 정보를 참조하여 Action을 선택할 수 있게 된다.
